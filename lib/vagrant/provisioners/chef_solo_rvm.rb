  ...
  module Provisioners
    ...
    class ChefSoloRvm < Chef
      ...
      def run_chef_solo
        ...
        command = "rvmsudo #{command_env}#{chef_binary_path("chef-solo")} -c #{config.provisioning_path}/solo.rb -j #{config.provisioning_path}/dna.json"
        ...
        config.attempts.times do |attempt|
          ...
          exit_status = env[:vm].channel.execute(command, :error_check => false) do |type, data|
